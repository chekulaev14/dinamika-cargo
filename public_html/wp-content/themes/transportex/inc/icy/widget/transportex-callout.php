<?php 
add_action('admin_enqueue_scripts', 'transportex_callout_widget_scripts');

function transportex_callout_widget_scripts() {    

    wp_enqueue_media();

}

class transportex_callout_widget extends WP_Widget{

    public function __construct() {
        parent::__construct(
            'transportex_callout_widget',
            __( 'Tx - Callout Widget', 'transportex' )
        );
    }
...
<div class="container">
    ...
    function form($instance) { ?>
        ...
        <table>
			<tr>
               <td>
                    <label for="<?php echo $this->get_field_id('name'); ?>"><?php _e('Title', 'transportex'); ?></label>
                </td>
            </tr>
            <tr>
                <td>
		...
		<table>
		<p>
            <label for="<?php echo $this->get_field_id('description'); ?>"><?php _e('Description', 'transportex'); ?></label><br/>
		...
		<table>
        	...
        	<tr>
        		<td>
        			<label for="<?php echo $this->get_field_id('btn_one_more'); ?>"><?php _e('Button Text', 'transportex'); ?></label>
        		</td>
        		<td>
			...
			<tr>
        		<td>
        			<label for="<?php echo $this->get_field_id('btn_two_more'); ?>"><?php _e('Button Text', 'transportex'); ?></label>
        		</td>
        		<td>
