...
function customizer_repeater_refresh_general_control_values() {
    ...
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
			...
			var test_title = jQuery(this).find('.customizer-repeater-test-title-control').val();
            ...
            if (text !== '' || image_url !== '' || title !== '' || subtitle !== '' || test_title !== '' || icon_value !== '' || link !== '' || designation !== '' || open_new_tab !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || color !== '' || button_text !== '' || slide_format !== '' || video_url !== '') {
                values.push({
					...
					'test_title': escapeHtml(test_title),
...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        if (typeof th !== 'undefined') {
            ...
            if(th.attr('id') == 'customize-control-transportex_testimonial_content'){

                //this code for customizer -repeater- limit {
            if( th.find("#transportex_service_limit").val() >= 2 )
            {
               
                th.parent().find(".customizer_transportex_upgrade_section").show();
                return false;
            }
            else
            { 
               var total_services_sections=parseInt(th.find("#transportex_service_limit").val())+1;
               th.find("#transportex_service_limit").val(total_services_sections);
               var limit = th.find("#transportex_service_limit").val();
               if(limit <= 3)
            {
                th.parent().find(".customizer_transportex_upgrade_section").hide();
            }
            } // }
                ...
                //this code for customizer -repeater- limit {
            if( th.find("#transportex_service_limit").val() >= 3 )
            {
            ...
            if (typeof field !== 'undefined') {
                ...
                field.find('.customizer-repeater-subtitle-control').val('');
				 ...
				 /*Remove value from subtitle field*/
                field.find('.customizer-repeater-test-title-control').val('');
    ...
    theme_conrols.on('click', '.social-repeater-general-control-remove-field', function () {
        var this1 = jQuery(this).parent().parent().parent().parent();
        if(this1.attr('id') == 'customize-control-transportex_testimonial_content'){

            this1.find(".customizer-repeater-new-field").show();
            var total_service= parseInt(this1.find("#transportex_service_limit").val())-1;
            this1.find("#transportex_service_limit").val(total_service);
            var limit = this1.find("#transportex_service_limit").val();
            if(limit <= 2)
                    {
                        this1.parent().find(".customizer_transportex_upgrade_section").hide();
                    }
	...
	theme_conrols.on('keyup', '.customizer-repeater-test-title-control', function () {
        customizer_repeater_refresh_general_control_values();
    });
